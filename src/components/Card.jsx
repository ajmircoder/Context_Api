...
function Card() {
  ...
  return (<>
    <div className={`${first ? "bg-black" : "bg-white"} md:h-screen body`}>
      <div className=
        {`${first ? " bg-black card-div-white" : "bg-white card-div-black"}
          grid grid-cols-1 p-2 card-div rounded-md`}>
        ...
        <footer className='grid grid-rows-3 grid-cols-1 md:flex'>
          <div>
